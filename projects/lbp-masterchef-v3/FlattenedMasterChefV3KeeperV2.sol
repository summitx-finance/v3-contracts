...
// File @chainlink/contracts/src/v0.8/KeeperCompatible.sol@v0.6.1
...
interface IMasterChefV2 {
    ...
    function pendingSummitX(uint256 _pid, address _user) external view returns (uint256);
...
// File contracts/keeper/LBPMasterChefV3KeeperV2.sol
 ...
 */
contract LBPMasterChefV3KeeperV2 is KeeperCompatibleInterface, Ownable, Pausable {
