...
import './interfaces/callback/ISummitXV3MintCallback.sol';
import './interfaces/callback/ISummitXV3SwapCallback.sol';
import './interfaces/callback/ISummitXV3FlashCallback.sol';

import '@summitx/v3-lm-pool/contracts/interfaces/ISummitXV3LmPool.sol';
...
contract SummitXV3Pool is ISummitXV3Pool {
    ...
    function _autoCollectProtocolFees() internal {
        address collector = ISummitXV3Factory(factory).protocolFeeCollector();
        ...
        try IProtocolFeeCollector(collector).collectProtocolFees(ISummitXV3Pool(this)) {} catch {}
    }
}