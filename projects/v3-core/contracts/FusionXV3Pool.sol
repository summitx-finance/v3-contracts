...
import './interfaces/IFusionXV3PoolDeployer.sol';
import './interfaces/IFusionXV3Factory.sol';
...
contract FusionXV3Pool is IFusionXV3Pool {
    ...
    // liquidity mining
    IFusionXV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IFusionXV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IFusionXV3PoolDeployer(msg.sender).parameters();
    ...
    function mint(
        ...
        IFusionXV3MintCallback(msg.sender).fusionXV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IFusionXV3SwapCallback(msg.sender).fusionXV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IFusionXV3FlashCallback(msg.sender).fusionXV3FlashCallback(fee0, fee1, data);
