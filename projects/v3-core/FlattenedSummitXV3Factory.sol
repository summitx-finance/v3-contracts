...
// File contracts/SummitXV3Factory.sol
...
contract SummitXV3Factory is ISummitXV3Factory {
    /***/
    ...
    function setFeeProtocol(address pool, uint32 feeProtocol0, uint32 feeProtocol1) external override onlyOwner {
        ISummitXV3Pool(pool).setFeeProtocol(feeProtocol0, feeProtocol1);
    }
    ...
    function collectProtocol(
        ...
        return ISummitXV3Pool(pool).collectProtocol(recipient, amount0Requested, amount1Requested);
    }

    function setLmPool(address pool, address lmPool) external override onlyOwnerOrLmPoolDeployer {
        ISummitXV3Pool(pool).setLmPool(lmPool);
    }
}
