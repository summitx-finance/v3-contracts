...
// File @summitx/v3-lm-pool/contracts/interfaces/ISummitXV3LmPool.sol@v1.0.0

// SPDX-License-Identifier: GPL-2.0-or-1later
pragma solidity >=0.5.0;

interface ISummitXV3LmPool {
...
// File contracts/interfaces/callback/ISummitXV3FlashCallback.sol
...
// File contracts/interfaces/callback/ISummitXV3MintCallback.sol


pragma solidity >=0.5.0;

/// @title Callback for ISummitXV3PoolActions#mint
/// @notice Any contract that calls ISummitXV3PoolActions#mint must implement this interface
interface ISummitXV3MintCallback {
    /// @notice Called to `msg.sender` after minting liquidity to a position from ISummitXV3Pool#mint.
    /// @dev In the implementation you must pay the pool tokens owed for the minted liquidity.
    /// The caller of this method must be checked to be a SummitXV3Pool deployed by the canonical SummitXV3Factory.
    /// @param amount0Owed The amount of token0 due to the pool for the minted liquidity
    /// @param amount1Owed The amount of token1 due to the pool for the minted liquidity
    /// @param data Any data passed through by the caller via the ISummitXV3PoolActions#mint call
...
// File contracts/interfaces/callback/ISummitXV3SwapCallback.sol


pragma solidity >=0.5.0;

/// @title Callback for ISummitXV3PoolActions#swap
/// @notice Any contract that calls ISummitXV3PoolActions#swap must implement this interface
interface ISummitXV3SwapCallback {
    /// @notice Called to `msg.sender` after executing a swap via ISummitXV3Pool#swap.
    ...
    /// @param data Any data passed through by the caller via the ISummitXV3PoolActions#swap call
...
/// @title Minimal ERC20 interface for SummitX
/// @notice Contains a subset of the full ERC20 interface that is used in SummitX V3
...
// File contracts/interfaces/ISummitXV3Factory.sol


pragma solidity >=0.5.0;

/// @title The interface for the SummitX V3 Factory
/// @notice The SummitX V3 Factory facilitates creation of SummitX V3 pools and control over the protocol fees
interface ISummitXV3Factory {
...
// File contracts/interfaces/pool/ISummitXV3PoolActions.sol
...
interface ISummitXV3PoolActions {
    ...
    /// @dev The caller of this method receives a callback in the form of ISummitXV3MintCallback#SummitXV3MintCallback
    ...
    /// @dev The caller of this method receives a callback in the form of ISummitXV3SwapCallback#SummitXV3SwapCallback
    ...
    /// @dev The caller of this method receives a callback in the form of ISummitXV3FlashCallback#SummitXV3FlashCallback
...
// File contracts/interfaces/pool/ISummitXV3PoolDerivedState.sol
...
interface ISummitXV3PoolDerivedState {
...
// File contracts/interfaces/pool/ISummitXV3PoolEvents.sol
...
interface ISummitXV3PoolEvents {
...
// File contracts/interfaces/pool/ISummitXV3PoolImmutables.sol
...
interface ISummitXV3PoolImmutables {
    /// @notice The contract that deployed the pool, which must adhere to the ISummitXV3Factory interface
...
// File contracts/interfaces/pool/ISummitXV3PoolOwnerActions.sol
...
interface ISummitXV3PoolOwnerActions {
...
// File contracts/interfaces/pool/ISummitXV3PoolState.sol
...
// File contracts/interfaces/ISummitXV3Pool.sol
...
// File contracts/interfaces/ISummitXV3PoolDeployer.sol


pragma solidity >=0.5.0;

/// @title An interface for a contract that is capable of deploying SummitX V3 Pools
/// @notice A contract that constructs a pool must implement this to pass arguments to the pool
/// @dev This is used to avoid having constructor arguments in the pool contract, which results in the init code hash
/// of the pool being constant allowing the CREATE2 address of the pool to be cheaply computed on-chain
interface ISummitXV3PoolDeployer {
...
// File contracts/SummitXV3Pool.sol
...
contract SummitXV3Pool is ISummitXV3Pool {
    using LowGasSafeMath for uint256;
    using LowGasSafeMath for int256;
    using SafeCast for uint256;
    using SafeCast for int256;
    ...
    // liquidity mining
    ISummitXV3LmPool public lmPool;
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == ISummitXV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = ISummitXV3PoolDeployer(msg.sender).parameters();
    ...
    function mint(
        ...
        ISummitXV3MintCallback(msg.sender).summitxV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            ISummitXV3SwapCallback(msg.sender).summitxV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        ISummitXV3FlashCallback(msg.sender).summitxV3FlashCallback(fee0, fee1, data);
    ...
    function setLmPool(address _lmPool) external override onlyFactoryOrFactoryOwner {
      lmPool = ISummitXV3LmPool(_lmPool);
