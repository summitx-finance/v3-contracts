...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IMuchFiV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function muchfiV3SwapCallback(
        ...
        IMuchFiV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IMuchFiV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
