...
} from '@muchfi/v3-core/artifacts/contracts/MuchFiV3Factory.sol/MuchFiV3Factory.json'
import {
  abi as DEPLOYER_ABI,
  bytecode as DEPLOYER_BYTECODE,
} from '@muchfi/v3-core/artifacts/contracts/MuchFiV3PoolDeployer.sol/MuchFiV3PoolDeployer.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@uniswap/v2-core/build/UniswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { IMuchFiV3Factory, IWETH9, MockTimeSwapRouter } from '../../typechain-types'
...
const v3CoreFactoryFixture: Fixture<{ deployer: Contract; factory: IMuchFiV3Factory }> = async ([wallet]) => {
