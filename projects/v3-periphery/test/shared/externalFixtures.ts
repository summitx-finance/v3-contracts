...
} from '@summitx/v3-core/artifacts/contracts/SummitXV3Factory.sol/SummitXV3Factory.json'
import {
  abi as DEPLOYER_ABI,
  bytecode as DEPLOYER_BYTECODE,
} from '@summitx/v3-core/artifacts/contracts/SummitXV3PoolDeployer.sol/SummitXV3PoolDeployer.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@uniswap/v2-core/build/UniswapV2Factory.json'
import { Fixture } from 'ethereum-waffle'
import { ethers, waffle } from 'hardhat'
import { ISummitXV3Factory, IWETH9, MockTimeSwapRouter } from '../../typechain-types'
...
const v3CoreFactoryFixture: Fixture<{ deployer: Contract; factory: ISummitXV3Factory }> = async ([wallet]) => {
