...
describe('NFTDescriptor', () => {
  ...
  function constructTokenMetadata(
    ...
    return {
      name: `SummitX - ${feeTier} - ${quoteTokenSymbol}/${baseTokenSymbol} - ${prices}`,
      description: `This NFT represents a liquidity position in a SummitXSwap V3 ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
