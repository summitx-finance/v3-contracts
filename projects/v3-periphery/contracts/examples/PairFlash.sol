...
import '@summitx/v3-core/contracts/interfaces/callback/ISummitXV3FlashCallback.sol';
...
/// @notice An example contract using the SummitXV3 flash function
contract PairFlash is ISummitXV3FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `SummitXV3FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        ISummitXV3Pool pool = ISummitXV3Pool(PoolAddress.computeAddress(deployer, poolKey));
